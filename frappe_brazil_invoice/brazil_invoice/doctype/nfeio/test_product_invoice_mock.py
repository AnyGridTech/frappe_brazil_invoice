...
"""
Mock Unit Tests for Product Invoice Operations with NFe.io API
...
To run these tests:
    bench --site dev.localhost run-tests --module frappe_brazil_invoice.brazil_invoice.doctype.nfeio.test_product_invoice_mock
"""
...
# Set up test logger
test_logger = logging.getLogger("product_invoice_mock_tests")
test_logger.setLevel(logging.INFO)


def setUpModule():
    """Set up test data once for the entire module"""
    test_logger.info("Setting up Product Invoice Mock test module")
    ensure_test_config_exists()


def tearDownModule():
    """Clean up test data after all tests in the module"""
    test_logger.info("Tearing down Product Invoice Mock test module")
...
class TestProductInvoice(FrappeTestCase):
    """Test cases for Product Invoice operations with mocked API"""
