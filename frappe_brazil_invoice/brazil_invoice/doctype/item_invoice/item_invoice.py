...
class ItemInvoice(Document):
	...
	def _auto_fill_from_serial_number(self):
		"""Stage 1: Auto-fill item_code from serial number"""
	...
	def _auto_fill_from_item(self):
		"""Stage 2: Auto-fill other fields from item_code
		
		This works whether item_code came from serial_number or was provided directly
		"""
		if self.item_code:
